...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    private Button btn_0, btn_1, btn_2, btn_3, btn_4, btn_5, btn_6,
            btn_7, btn_8, btn_9;//数字0-9按钮
    private Button btn_clear;//清除按钮
    private Button btn_percent, btn_del, btn_PandM, btn_squ2, btn_div, btn_mul,
            btn_sub, btn_add, btn_equ, btn_p;//运算符
    private EditText text;//文本输入框
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_0.setOnClickListener(this);//添加点击事件
